...
//task32.error
var current_users = ["Ali", "AhMed", "NadEem", "Hamza", "Admin"];
var new_users = ["Ali", "Ahmed", "Dawod", "jamel", "Tariq"];
new_users.forEach(function (newusername) {
    ...
    if (current_users.map(function (c_user) { return c_user.toLowerCase(); }).includes(lowercase)) {
        console.log("The username ".concat(newusername, " is not availabel write a diffrent  username"));
    }
    else {
